package website.marcosfernandes.infrastructure.data;
...
public class EmployeeRepository {
    private static final List<Funcionario> employees = new ArrayList<>();
    ...
    static {
        ...
        employees.add(new Funcionario("Alice", LocalDate.of(1995, 1, 5), new BigDecimal("2234.68"), "Recepcionista"));
